...
# ruta xml origen
# ruta xml junit
#$ruta_xml_origen = "C:\Globe\12_Local\Vueling\Fase_2\Estructura git\Automation\tools\run_results.xml"
#$ruta_xml_junit = "C:\Globe\12_Local\Vueling\Fase_2\Estructura git\Automation\tools\reporte_TC1.xml"
